...
admins = { "jordy@example.com", "admin@example.com", "gateway01@example.com"}
...
Component "pubsub.example.com" "pubsub"
	-- ssl = { 
	-- 	key = "/var/lib/prosody/pubsub.example.com.key";
	-- 	certificate = "/var/lib/prosody/pubsub.example.com.crt";
	-- }
	
	-- component_interface = "10.5.0.2"
