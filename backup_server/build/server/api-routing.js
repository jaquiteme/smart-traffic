...
router.route('/road_messages/length')
    .get(RoadMessageController.number_of_messages)

router.route('/road_messages/cars')
    .get(RoadMessageController.cars)

router.route('/road_messages/cars/length')
    .get(RoadMessageController.number_of_cars)

router.route('/road_messages/gateways')
    .get(RoadMessageController.gateways)
router.route('/road_messages/gateways/length')
    .get(RoadMessageController.number_of_gateways)
