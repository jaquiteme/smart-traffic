...
var notImplemented = require("jsdom/lib/jsdom/browser/not-implemented");
var History = require("jsdom/lib/jsdom/browser/history");
var VirtualConsole = require("jsdom/lib/jsdom/virtual-console");
var define = require("jsdom/lib/jsdom/utils").define;
var inherits = require("jsdom/lib/jsdom/utils").inheritFrom;
...
var postMessage = require("jsdom/lib/jsdom/living/post-message");
const DOMException = require("jsdom/lib/jsdom/web-idl/DOMException");
const btoa = require("jsdom/lib/base64").btoa;
const atob = require("jsdom/lib/base64").atob;
...
var defaultStyleSheet = cssom.parse(require("jsdom/lib/jsdom/browser/default-stylesheet"));
