...
const addMessageEventToCore = require("jsdom/lib/jsdom/living/message-event");
const addErrorEventToCore = require("jsdom/lib/jsdom/living/error-event");
const addHashChangeEventToCore = require("jsdom/lib/jsdom/living/hash-change-event");
...
core.EventTarget = require('jsdom/lib/jsdom/events/EventTarget');
