...
var resourceLoader        = require('jsdom/lib/jsdom/browser/resource-loader'),
    core                  = require("jsdom/lib/jsdom/level1/core"),
    applyDocumentFeatures = require('jsdom/lib/jsdom/browser/documentfeatures').applyDocumentFeatures,
    defineGetter          = require('jsdom/lib/jsdom/utils').defineGetter,
    defineSetter          = require('jsdom/lib/jsdom/utils').defineSetter,
    inheritFrom           = require("jsdom/lib/jsdom/utils").inheritFrom,
    URL                   = require("jsdom/lib/jsdom/utils").URL,
    resolveHref           = require("jsdom/lib/jsdom/utils").resolveHref,
    Window                = require("jsdom/lib/jsdom/browser/Window"),
    documentBaseURL       = require("jsdom/lib/jsdom/living/helpers/document-base-url").documentBaseURL,
    fallbackBaseURL       = require("jsdom/lib/jsdom/living/helpers/document-base-url").fallbackBaseURL,
    fs                    = require("fs"),
    mapper                = require("jsdom/lib/jsdom/utils").mapper,
    addConstants          = require("jsdom/lib/jsdom/utils").addConstants,
...
core.languageProcessors = {
  javascript : require("jsdom/lib/jsdom/level2/languages/javascript").javascript
};
