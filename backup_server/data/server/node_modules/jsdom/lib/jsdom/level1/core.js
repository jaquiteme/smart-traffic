...
*/
var inheritFrom = require("jsdom/lib/jsdom/utils").inheritFrom;
var domToHtml = require("jsdom/lib/jsdom/browser/domtohtml").domToHtml;
var defineGetter = require("jsdom/lib/jsdom/utils").defineGetter;
var memoizeQuery = require("jsdom/lib/jsdom/utils").memoizeQuery;
var resolveHref = require("jsdom/lib/jsdom/utils").resolveHref;
var validateName = require('jsdom/lib/jsdom/living/helpers/validate-names').name;
var HtmlToDom = require("jsdom/lib/jsdom/browser/htmltodom").HtmlToDom;
var Location = require("jsdom/lib/jsdom/browser/location");
var vm = require("vm");
var CookieJar = require('tough-cookie').CookieJar;
var EventTarget = require("jsdom/lib/jsdom/events/EventTarget");
var attributes = require("jsdom/lib/jsdom/living/attributes");
var mapper = require("jsdom/lib/jsdom/utils").mapper;
var clone = require("jsdom/lib/jsdom/living/node").clone;
var namedPropertiesWindow = require("jsdom/lib/jsdom/living/named-properties-window");
var Window = require('jsdom/lib/jsdom/browser/Window');
var proxiedWindowEventHandlers = require("jsdom/lib/jsdom/living/helpers/proxied-window-event-handlers");
...
core.DOMException = require("jsdom/lib/jsdom/web-idl/DOMException");
core.NamedNodeMap = require("jsdom/lib/jsdom/living/attributes").NamedNodeMap;
